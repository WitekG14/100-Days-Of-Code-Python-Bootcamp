Celem jest stworzenie programu do aukcji w ciemno.

### Demo
https://appbrewery.github.io/python-day9-demo/

### Czyszczenie Wydruku
Istnieje kilka sposobów na czyszczenie wydruku. Najprostszym jest po prostu wydrukowanie `"\n"` wiele razy, aby wydruk przesunął się o wiele linii w dół.

np.
```
# To doda 20 nowych linii do wydruku
print("\n" * 20)
```

### Funkcjonalność
- Każda osoba wpisuje swoje imię i ofertę.
- Program pyta, czy są inne osoby, które chcą wziąć udział w licytacji. Jeśli tak, komputer czyści wydruk (drukuje kilka pustych linii), a następnie wraca do pytania o imię i ofertę.
- Imię i oferta każdej osoby są zapisywane w słowniku.
- Gdy wszyscy uczestnicy złożą swoje oferty, program sprawdza, kto złożył najwyższą ofertę, i wypisuje wynik.
